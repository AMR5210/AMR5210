...
MS Information Systems student at Northeastern University (Boston). I build across embedded systems, iOS, ML, and full-stack. I hold Two Indian patents as co-inventor in drone navigation firmware and GPU core optimization.
...
- **MBTA Live** — Real-time Boston transit tracker in Swift/SwiftUI and Flutter. [Live](https://mbtalive.vercel.app) · [Code](https://github.com/AMR5210/MBTALive)
- **Rover Notes** — RAG note-taking app with FastAPI, React, and OpenAI. [Live](https://rover-notes-app-jet.vercel.app) · [Code](https://github.com/AMR5210/rover-notes-app)
- **VoiceTrack** — Voice analysis app with Django, React Native, and librosa. [Code](https://github.com/AMR5210/Voicetrack_ap)
- **LabInsight AI** — Lab report analyzer with Angular, Node.js, and Groq. [Code](https://github.com/AMR5210/LabInsightsAI)
